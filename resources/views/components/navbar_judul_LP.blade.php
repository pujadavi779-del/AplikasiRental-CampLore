...
@php
    // Ambil data langsung di komponen agar aman & tidak perlu passing manual dari controller
    $unrepliedCount = \App\Models\Review::where('is_replied', false)
            ...
            <div x-show="open" @click.outside="open = false" x-cloak
                ...
                <div class="divide-y divide-[#eef4f0] max-h-64 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.reviews.index') }}"
                        ...
                        {{-- Avatar Profil - SEKARANG MUNCULIN FOTO ASLI --}}
