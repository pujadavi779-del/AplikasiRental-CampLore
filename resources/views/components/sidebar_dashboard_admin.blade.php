<aside class="w-[272px] min-h-screen bg-gradient-to-b from-[#22543D] to-[#163527] fixed top-0 left-0 bottom-0 flex flex-col z-40 overflow-y-auto">
    {{-- Logo --}}
    <a href="{{ url('/admin/dashboard_admin') }}" class="flex items-center gap-3 px-6 py-6 border-b border-white/10"> 
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5" x-data="{ openRiwayat: {{ request()->is('dashboard/admin/riwayat*') ? 'true' : 'false' }} }">
        ...
        <a href="{{ url('/admin/pengiriman') }}"
            class="nav-item {{ request()->is('dashboard/admin/pengiriman') ? 'active' : '' }} flex items-center gap-3 px-4 py-2.5 rounded-xl text-emerald-100 hover:text-white text-sm font-semibold transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ url('/admin/pengembalian') }}"
            class="nav-item {{ request()->is('dashboard/admin/pengembalian') ? 'active' : '' }} flex items-center justify-between px-4 py-2.5 rounded-xl text-emerald-100 hover:text-white text-sm font-semibold transition-all">
            <span class="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
