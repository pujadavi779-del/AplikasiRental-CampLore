@once
    @push('styles')
        ...
        <style>
            aside, aside *, .chip-btn, .chip-btn *, .drawer, .drawer * {
...
<aside class="w-64 shrink-0 pt-2 hidden lg:block">
    ...
    <div class="grid grid-cols-3 gap-3">
        ...
        <div class="cursor-pointer text-center group">
            <div class="aspect-square rounded-xl border border-gray-200 bg-white flex items-center justify-center overflow-hidden
                        group-hover:border-gray-400 group-hover:shadow-sm transition-all duration-300">
            ...
            <p class="mt-1 text-[10px] text-gray-400 font-semibold uppercase tracking-wide">{{ $merek->name }}</p>
        </div>
        @endforeach
    </div>
</aside>
