...
@section('title', 'Camera - Camplore')

@section('content')
<section class="py-16 max-w-7xl mx-auto px-4">
    <div class="mb-10" data-aos="fade-up">
        <a href="{{ route('home') }}" class="text-sm text-gray-400 hover:text-[#22543D] transition">← Kembali</a>
        <h1 class="text-4xl font-extrabold text-[#22543D] mt-3"> Camera Collection</h1>
        <p class="text-gray-500 mt-2">Pilih kamera profesional untuk petualanganmu.</p>
    </div>
