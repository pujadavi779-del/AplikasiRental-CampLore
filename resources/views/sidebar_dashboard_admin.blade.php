...
<nav id="top-navbar" class="fixed top-0 z-50 sm:ml-64" style="width:calc(100% - 16rem)">
    <div class="px-5 py-3 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="n-divv hidden md:block"></div>
            <button class="n-icon" title="Cart">
        ...
        a2 2 0 0 0 2-1.61L23 6H6"></path>
            ...
            <a href="{{ url('/profile') }}" class="n-icon" title="Profile">
                <img src="{{ Auth::user()->profile_photo_url ?? 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name ?? 'U').'&background=3d6e12&color=d4f0a0' }}" style="width:26px;height:26px;border-radius:50%;object-fit:cover;" alt="Profile">
            </a>
        </div>
    </div>
</nav>
