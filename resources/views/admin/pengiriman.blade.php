...
<body class="antialiased">
            ...
            <div class="bg-white rounded-[28px] border border-[#d7e6de] shadow-sm overflow-hidden">
                ...
                <div class="p-5 bg-[#fcfdfb]">
                    <div class="relative flex-1">
                        ...
                        <input type="text" placeholder="Cari nama pelanggan atau produk..."
                            class="w-full bg-white border border-[#d7e6de] text-xs py-2.5 pl-11 pr-4 rounded-xl outline-none focus:ring-1 focus:ring-[#22543D] transition-all">
                    </div>
                </div>
                        ...
                        <tbody class="divide-y divide-[#eef4f0]">
                            ...
                            <tr class="hover:bg-[#fcfdfb] transition-colors">
                                <td class="px-8 py-5 flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-xl bg-[#22543D] flex items-center justify-center text-white font-bold text-sm shadow-sm border border-[#d7e6de]">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="p-10 text-center text-[11px] text-[#7c8b84]">Belum ada data pengiriman.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="p-5 bg-[#fcfdfb] border-t border-[#eef4f0] flex items-center justify-between">
                    <p class="text-[10px] font-bold text-[#22543D] uppercase tracking-widest">
                        Menampilkan 1 data pengiriman
                    </p>
                    <div class="flex gap-2">
                        <button class="w-10 h-10 flex items-center justify-center border border-gray-100 rounded-2xl text-gray-300 hover:bg-gray-50 transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                            </svg>
                        </button>
                        <button class="w-10 h-10 flex items-center justify-center bg-[#5a7a3a] text-white font-bold text-sm rounded-2xl shadow-lg shadow-[#5a7a3a]/20">
                            1
                        </button>
                        <button class="w-10 h-10 flex items-center justify-center border border-gray-100 rounded-2xl text-gray-300 hover:bg-gray-50 transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- MODAL KONFIRMASI (Warna disesuaikan ke Hijau Gelap #22543D) --}}
    <div id="modalConfirm" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-[#1a2e23]/40 backdrop-blur-sm transition-all duration-300 opacity-0">
        <div class="bg-[#f4f5ed] w-[90%] max-w-sm rounded-[28px] p-8 shadow-2xl border border-[#c8c9b4] text-center relative transform scale-95 transition-all duration-300" id="modalCard">
            <button onclick="closeModal()" class="absolute top-4 right-4 text-[#7a8060] hover:text-[#22543D] transition">
