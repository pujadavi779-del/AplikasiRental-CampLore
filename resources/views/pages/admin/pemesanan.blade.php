                    ...
                    <tr>
                        <th class="px-6 py-3 w-10">
                            <input type="checkbox" id="checkAll" onclick="toggleAll(this)"
                                class="w-4 h-4 rounded border-gray-300 text-[#22543D] accent-[#22543D] cursor-pointer">
                        </th>
                        ...
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable('name')">
...
<script>
    ...
    function renderRows() {
        ...
        <tr class="hover:bg-[#fcfdfb] transition-colors">
            ...
            <td class="px-4 py-4">
                <span class="font-mono text-[11px] text-gray-400 bg-gray-100 border border-gray-200 rounded px-2 py-0.5">${r.id}</span>
            </td>
            <td class="px-4 py-4">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full flex items-center justify-center text-[11px] font-semibold flex-shrink-0 ${avClass}">${r.av}</div>
                    <div>
                        <div class="font-semibold text-[#22543D] text-sm leading-tight">${r.name}</div>
                        <div class="text-[11px] text-gray-400">${r.email}</div>
                    </div>
                </div>
            </td>
            <td class="px-4 py-4">${prods}</td>
            <td class="px-4 py-4 whitespace-nowrap">
                <span class="font-mono font-semibold text-[#22543D] text-sm">${fmt(r.price)}</span>
                <span class="ml-1 text-[10px] text-gray-300 bg-gray-100 rounded px-1.5 py-0.5">${r.days}hr</span>
            </td>
            <td class="px-4 py-4">
                <span class="text-[11px] font-semibold px-2.5 py-1 rounded-full ${badge}">${r.status}</span>
            </td>
            <td class="px-4 py-4 text-xs text-gray-400 whitespace-nowrap">${fmtDate(r.date)}</td>
            <td class="px-4 py-4">
                <div class="flex items-center justify-center gap-1.5">
                    <button class="text-xs text-[#22543D] border border-[#d7e6de] rounded-lg px-3 py-1.5 hover:bg-[#f1f8f4] transition-colors font-medium">
                        Detail
                    </button>
                    <button class="text-xs text-red-400 border border-red-100 rounded-lg px-3 py-1.5 hover:bg-red-50 transition-colors font-medium">
                        Hapus
                    </button>
                </div>
            </td>
