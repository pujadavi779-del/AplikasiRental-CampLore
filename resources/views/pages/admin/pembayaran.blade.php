...
<style>
    ...
    @keyframes pulse-green {
        ...
        0%,
        100% {
            box-shadow: 0 0 0 0 rgba(34, 84, 61, .3);
        }

        50% {
            box-shadow: 0 0 0 6px rgba(34, 84, 61, 0);
        }
    }
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left min-w-[900px]">
                ...
                <tbody class="divide-y divide-[#f0f7f3]">
                    ...
                    @php
                    $statusMap = [
                    'belum_bayar' => ['label' => 'Proses', 'badge' => 'badge-proses', 'color' => 'orange'],
                    'dikemas' => ['label' => 'Lunas', 'badge' => 'badge-lunas', 'color' => 'emerald'],
                    'dikirim' => ['label' => 'Lunas', 'badge' => 'badge-lunas', 'color' => 'emerald'],
