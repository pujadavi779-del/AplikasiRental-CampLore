...
<head>
    ...
    <style>
        ...
        /* Hero parallax blob */
        .blob-pink {
            background: radial-gradient(ellipse at center, #ED64A6 0%, transparent 70%);
        }
        .blob-green {
            background: radial-gradient(ellipse at center, #22543D 0%, transparent 70%);
        }
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 20px 40px rgba(237,100,166,0.15);
        }
        ...
        .team-card:hover {
            ...
            box-shadow: 0 24px 48px rgba(34,84,61,0.15);
        }
        .team-card:hover .avatar-ring {
            border-color: #ED64A6;
            box-shadow: 0 0 0 4px rgba(237,100,166,0.2);
        }
        .avatar-ring {
...
<!-- ========== NAVBAR ========== -->
<nav class="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-pink-100 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        <a href="#" class="flex items-center gap-2">
            <div class="w-9 h-9 bg-[#22543D] rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                </svg>
            </div>
            <span class="text-2xl font-extrabold text-[#22543D]">Camp<span class="text-[#ED64A6]">lore</span></span>
        </a>
        <div class="hidden md:flex items-center gap-8 text-sm font-semibold text-gray-700">
            <a href="#" class="hover:text-[#22543D] transition">Home</a>
            <a href="#" class="text-[#ED64A6]">About</a>
            <a href="#" class="hover:text-[#22543D] transition">Catalog</a>
        </div>
        <div class="flex items-center gap-3">
            <button class="border-2 border-[#22543D] text-[#22543D] px-5 py-2 rounded-full text-sm font-bold hover:bg-[#22543D] hover:text-white transition">Login →</button>
        </div>
    </div>
</nav>
...
<section class="relative min-h-[60vh] flex items-center justify-center bg-[#22543D] overflow-hidden pt-20">
    ...
    <!-- Blobs -->
    <div class="absolute top-0 right-0 w-96 h-96 blob-pink opacity-10 blur-3xl"></div>
...
<section class="py-24 max-w-7xl mx-auto px-4">
    <div class="grid md:grid-cols-2 gap-16 items-center">
        ...
        <div class="grid grid-cols-2 gap-4 relative" data-aos="fade-right" data-aos-duration="1100">
            <div class="space-y-4">
                <img src="https://images.unsplash.com/photo-1510312305653-8ed496efae75?auto=format&fit=crop&q=80" class="rounded-3xl h-64 w-full object-cover shadow-2xl border-4 border-white" alt="Adventure camping">
                <img src="https://images.unsplash.com/photo-1526772662000-3f88f10405ff?auto=format&fit=crop&q=80" class="rounded-3xl h-44 w-full object-cover shadow-lg" alt="Tent at sunset">
            </div>
            <div class="pt-10 space-y-4">
                <img src="https://images.unsplash.com/photo-1520390138845-fd2d229dd553?auto=format&fit=crop&q=80" class="rounded-3xl h-52 w-full object-cover shadow-xl border-4 border-white" alt="Camera rental">
                <img src="https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&q=80" class="rounded-3xl h-56 w-full object-cover shadow-lg" alt="Camping gear">
            </div>
            <!-- Decorative ring -->
            <div class="absolute -bottom-8 -left-8 w-24 h-24 border-8 border-[#ED64A6]/20 rounded-full z-[-1]"></div>
            <div class="absolute -top-6 -right-6 w-16 h-16 bg-[#22543D]/10 rounded-full z-[-1]"></div>
        </div>
        ...
        <div data-aos="fade-left" data-aos-duration="1100">
            ...
            <div class="grid grid-cols-2 gap-5">
                <div class="flex items-center gap-3" data-aos="fade-up" data-aos-delay="0">
                    <div class="w-11 h-11 bg-emerald-100 rounded-2xl flex items-center justify-center text-[#22543D]">
                ...
                <div class="flex items-center gap-3" data-aos="fade-up" data-aos-delay="150">
                    <div class="w-11 h-11 bg-emerald-100 rounded-2xl flex items-center justify-center text-[#22543D]">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    </div>
...
<section class="py-24 bg-[#FFF5F7]">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Stat 1 -->
            <div class="stat-card bg-white rounded-3xl p-8 border border-pink-100 shadow-sm" data-aos="fade-up" data-aos-delay="0">
                <div class="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center mb-5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#22543D]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/></svg>
                </div>
            ...
            <!-- Stat 2 -->
            <div class="stat-card bg-white rounded-3xl p-8 border border-pink-100 shadow-sm" data-aos="fade-up" data-aos-delay="150">
                <div class="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center mb-5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#22543D]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017a2 2 0 01-1.789-1.106L6.734 14H4a2 2 0 01-2-2V7a2 2 0 012-2h2.034a2 2 0 011.789 1.106L9 8h5z"/></svg>
                </div>
            ...
            <!-- Stat 3 -->
            <div class="stat-card bg-white rounded-3xl p-8 border border-pink-100 shadow-sm" data-aos="fade-up" data-aos-delay="300">
                <div class="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center mb-5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#22543D]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </div>
            ...
            <!-- Stat 4 -->
            <div class="stat-card bg-white rounded-3xl p-8 border border-pink-100 shadow-sm" data-aos="fade-up" data-aos-delay="450">
                <div class="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center mb-5">
        ...
        <div class="relative">
            ...
            <div class="grid md:grid-cols-3 gap-10">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="0">
                    <div class="w-20 h-20 mx-auto mb-4 rounded-full border-2 border-[#ED64A6]/60 bg-white/10 flex items-center justify-center">
                    ...
                    <div class="w-3 h-3 mx-auto mb-4 rounded-full bg-[#ED64A6] dot-pulse"></div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-20 h-20 mx-auto mb-4 rounded-full border-2 border-[#ED64A6]/60 bg-white/10 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-[#ED64A6]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>
                    </div>
                    <div class="w-3 h-3 mx-auto mb-4 rounded-full bg-[#ED64A6] dot-pulse"></div>
...
<section class="py-24 bg-[#FFF5F7]">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <!-- Team 1 -->
            <div class="team-card bg-white rounded-3xl p-8 border border-pink-100 shadow-sm text-center" data-aos="fade-up" data-aos-delay="0">
                <div class="avatar-ring w-28 h-28 mx-auto mb-5 rounded-full border-4 border-[#22543D] overflow-hidden shadow-lg">
            ...
            <div class="team-card bg-[#22543D] rounded-3xl p-8 border border-[#22543D] shadow-xl text-center -mt-4" data-aos="fade-up" data-aos-delay="150">
                <div class="avatar-ring w-28 h-28 mx-auto mb-5 rounded-full border-4 border-[#ED64A6] overflow-hidden shadow-lg">
            ...
            <!-- Team 3 -->
            <div class="team-card bg-white rounded-3xl p-8 border border-pink-100 shadow-sm text-center" data-aos="fade-up" data-aos-delay="300">
                <div class="avatar-ring w-28 h-28 mx-auto mb-5 rounded-full border-4 border-[#22543D] overflow-hidden shadow-lg">
    ...
    <div class="max-w-4xl mx-auto px-4 text-center" data-aos="zoom-in">
        <div class="bg-[#22543D] rounded-3xl p-14 relative overflow-hidden shadow-2xl">
            ...
            <div class="relative z-10 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#" class="bg-[#ED64A6] text-white px-10 py-4 rounded-full font-bold hover:bg-white hover:text-[#22543D] transition shadow-lg transform hover:scale-105">Browse Catalog</a>
