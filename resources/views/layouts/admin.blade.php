...
<head>
    ...
    <style>
        ...
        .nav-item { transition: all 0.18s ease; border-left: 3px solid transparent; }
        .nav-item:hover { background: rgba(255,255,255,0.08); border-left-color: #ED64A6; }
        .nav-item.active { background: rgba(255,255,255,0.12); border-left-color: #ED64A6; color: white; }
        .nav-badge { min-width: 20px; height: 20px; font-size: 0.65rem; }
        @yield('extra-style')
    </style>
    @stack('styles')
</head>
    ...
    <div class="ml-[240px] flex-1 flex flex-col min-h-screen">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="mb-5 flex items-center gap-3 bg-red-50 border border-red-200 text-red-800 px-5 py-3.5 rounded-xl text-sm font-semibold" id="flash-err">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                {{ session('error') }}
