    ...
    <nav class="bg-white/95 backdrop-blur-md sticky top-0 z-50 border-b border-pink-100">
        <div class="max-w-7xl mx-auto px-4 h-20 flex justify-between items-center">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-2xl font-extrabold text-[#1A392D]">Camp<span class="text-[#FF6B95]">lore</span></span>
            </div>

            <!-- Menu Tengah (Desktop) -->
            <div class="hidden md:flex space-x-8 font-bold text-xs uppercase tracking-widest text-[#1A392D]">
                <a href="#hero" class="hover:text-[#FF6B95] transition">Explorer</a>
                <a href="#about" class="hover:text-[#FF6B95] transition">The Kit</a>
                <a href="#catalog" class="hover:text-[#FF6B95] transition">Catalog</a>
            </div>
